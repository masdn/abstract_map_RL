...
class QLearning():
    ...
    '''
    def __init__(self, env, agent, num_episodes, num_steps, eps, lr, disc, seed=96):
        self.env = env
        self.agent = agent
    ...
    def run(self):
        '''
        Implementation of the QLearning Training Loop
        ...
        for e in range(self.num_episodes):
            ...
            for step in range(self.num_steps):
                ...
                #uses the best possible action from s_1
